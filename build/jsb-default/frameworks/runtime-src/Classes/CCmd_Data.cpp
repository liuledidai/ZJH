...
BYTE CCmd_Data::readbyte()
{
    if(read_offset % (sizeof(BYTE)) != 0)
    {
...
int CCmd_Data::readint()
{
    if(read_offset % (sizeof(int)) != 0)
    {
...
WORD CCmd_Data::readword()
{
    if(read_offset % (sizeof(WORD)) != 0)
    {
...
DWORD CCmd_Data::readdword()
{
    if(read_offset % (sizeof(DWORD)) != 0)
    {
...
//    SCORE readscore();
__int64 CCmd_Data::readint64()
{
    if(read_offset % (sizeof(__int64)) != 0)
    {
...
std::string CCmd_Data::readstring(WORD dataLen)
{
    if(dataLen == 0)
    {
...
bool CCmd_Data::readbool()
{
    if(read_offset % (sizeof(bool)) != 0)
    {
...
double CCmd_Data::readdouble()
{
    if(read_offset % (sizeof(double)) != 0)
    {
...
float CCmd_Data::readfloat()
{
    if(read_offset % (sizeof(float)) != 0)
    {
...
short CCmd_Data::readshort()
{
    if(read_offset % (sizeof(short)) != 0)
    {
